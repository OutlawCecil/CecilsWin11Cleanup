...
- **System basics**
  - Detects desktop vs laptop (for some behavior)  
  - Ensures it runs with admin rights  
  - Shows Windows version/build

- **Performance & UX**
  - Sets Num Lock on by default (desktops only)  
  - Sets timezone to Mountain Standard Time and resyncs time  
  - Applies “performance” visual settings (less animation/transparency)  
  - Makes File Explorer open to “This PC”  
  - Cleans up cluttered context menus and Quick Access  
  - Disables sleep/hibernation when plugged in

- **Privacy & telemetry**
  - Blocks a large list of Microsoft telemetry/metrics endpoints via HOSTS  
